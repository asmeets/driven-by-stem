...
5. Use [Definitions]({{ site.baseurl }}/educators/definitions/) during prep or follow-up, and keep [Accessibility]({{ site.baseurl }}/educators/accessibility/) and [Assessment & Reflection]({{ site.baseurl }}/educators/feedback/) nearby during facilitation.
