...
After a classroom session or live activation, use a short debrief to improve the next run. The goal is not to write a long report. The goal is to capture what affected launch, pacing, student understanding, and facilitation.

### Five-Minute Debrief Questions

- What launched smoothly, and what slowed learners down before the first build moment?
- Which pause point created the clearest student explanation?
- Where did learners need the most support: navigation, vocabulary, controls, prediction, or debugging?
- Did the session protect at least one compare-and-explain moment?
- What should change before the next group arrives or the next class runs it?

### Notes Worth Keeping

- timing blocks that ran long or short
- a prompt that produced strong student discussion
- a mechanic, page, or tutorial step that caused confusion
- accessibility or room-readability issues on the actual devices
- one concrete adjustment for the next session
