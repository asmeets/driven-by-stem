...
Handle the risk and recovery scoring, read the summary, pick a next-test focus, and connect the result to a career lens. All nine roles are named in the close, each against something you actually did.

**What is pre-built for them**

Race state, scoring, the summary screen, and the certificate flow.

**STEM skills applied**

Systems integration, reading across saved data, self-assessment, and explaining a result to someone else.
...
**What students should leave thinking**

*"I built a working system and I can point to the decisions that made it behave this way. These are real jobs, and I have done a version of the work."*
