...
Drive a full session, build the collision counters and the reward for clean driving, then read collision count against score and efficiency.

**What is pre-built for them**

Stage setup, background, dashboard, countdown, and obstacle spawning.

**STEM skills applied**

Counters and accumulation, collision detection, reading a live dashboard, and comparing saved results.
...
*"What I remember about the run and what the numbers say are two different things. The numbers are what a team acts on."*
